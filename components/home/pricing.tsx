        ...
        <TooltipProvider>
            <div className="mx-auto my-8 mt-10 flex flex-col items-center">
                <h2 className="mt-4 mb-0 text-3xl font-extrabold text-center tracking-[-0.03em] text-primary sm:text-4xl sm:leading-[3.5rem]">
                    <span className="mt-4 text-3xl font-extrabold tracking-[-0.03em] text-primary sm:text-4xl sm:leading-[3.5rem]">
                        Our Pricing Plans
                    </span>
                </h2>
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="sm:min-w-[360px] max-w-full rounded-2xl border border-input bg-white shadow-md text-left sm:mr-8 text-primary">
                        <div className="px-5 p-5">
                            <h3 className="text-2xl text-primary font-semibold leading-6">
                                Free
                            </h3>
                            ...
                            <div className="flex flex-col gap-2.5 tracking-wide">
                                ...
                                <p className="text-gray-600 flex items-center font-normal">
                                    {plans.free.limit.imports} time unlimited
                                    bookmarks import.
                                    <PlanTooltip
                                        className="ml-1 relative -top-1"
                                        text={messages.importLimitWarning(
                                ...
                                <p className="text-gray-600 flex items-center font-normal">
                                    {plans.free.limit.favorites} favorite
                                    bookmarks
                                </p>
                                <p className="text-gray-600 flex items-center font-normal">
                                    Share upto {plans.free.limit.share} tag
                                    publicly
                                </p>
                                <p className="text-gray-600 flex items-center font-normal"></p>
                                <p className="text-gray-600 flex items-center font-normal">
                                    Extensions
                                </p>
                            </div>
                    ...
                    <div className="min-w-[330px] bg-gradient-to-r from-sky-0 to-sky-50 via-white rounded-2xl border-2 border-sky-100 bg-white shadow-md text-left sm:mr-8 text-primary">
                        <div className="px-5 p-5">
                            ...
                            <div className="flex flex-col gap-2.5 tracking-wide">
                                ...
                                <p className="text-gray-600 flex items-center font-normal">
                                    {plans.pro.limit.imports} times unlimited
                                    bookmarks import.
                                    <PlanTooltip
                                        className="ml-1 relative -top-1"
                                        text={messages.importLimitWarning(
                                ...
                                <p className="text-gray-600 flex items-center font-normal">
                                    {plans.pro.limit.favorites} favorite
                                    bookmarks
                                </p>
                                <p className="text-gray-600 flex items-center font-normal">
                                    Share upto {plans.pro.limit.share} tags
                                    publicly
                                </p>
                                <p className="text-gray-600 flex items-center font-normal">
                                    CSV/HTML
